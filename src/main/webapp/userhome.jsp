<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"     import="com.klef.ep.models.User" %>
...
<%@page import="com.klef.ep.models.Transaction"%>
    ...
    long expenses=transactionService.viewExpenses(us) ;
    long incomes=transactionService.viewIncome(us);
    %>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body id="top" data-spy="scroll" data-target=".navbar-collapse" data-offset="50">
     ...
     <section class="navbar custom-navbar navbar-fixed-top" role="navigation">
          <div class="container">
               ...
               <div class="navbar-header">
                    ...
                    <!-- lOGO TEXT HERE -->
                    <a href="#" class="navbar-brand">SpendSmart</a>
               </div>

               <!-- MENU LINKS -->
               <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-nav-first">
                         <li><a href="userhome.jsp" class="smoothScroll">Home</a></li>
                         <li><a href="#about" class="smoothScroll">New Transaction</a></li>
                         <li><a href="history.jsp" class="smoothScroll">History</a></li>
                         <li><a href="#courses" class="smoothScroll">Recommendations</a></li>
                         <li><a href="#testimonial" class="smoothScroll">Limits</a></li>
     ...
     <!-- HOME -->
     <section id="home">
          <div class="row koushik">
                    <div class="home-slider owl-carousel owl-theme">
                         <div class="item">
                              <div class="caption">
                                   <div class="container">
                                        <div class="col-md-6 col-sm-12">
                                             <h1 style="color: black;">Hi <%=us.getName() %></h1>
                                             <h3 style="color: black;">Welcome to SpendSmart </h3>
                                        </div>
                                   </div>
                              </div>
                         </div>
                    ...
                    <div class="col-md-6 col-sm-12">
                         <div class="about-info">
                              ...
                              <form action="addtransaction.jsp" method="post">
                                   <select name="amttype" id="amtype" class="form-control" required>
                                        <option value="">Amount Type</option>
                                        <option value="expense">Expense(Like BusFare etc)</option>
                                        <option value="income">Income(Like Salary etc)</option>
                                   </select>
          
                                   <input type="text" name="name" class="form-control" placeholder="Name of the Transaction" required>
                                   <input type="number" name="amount" class="form-control" placeholder="Amount" required>
                                   <button type="submit" class="submit-btn form-control" id="form-submit">Add</button>
                              </form>
                         </div>
                         </div>
                    </div>
               ...
               <div class="row">
                    ...
                    <div class="col-md-4 col-sm-6">
                         <div class="footer-info">
                              ...
                              <address>
                                   <p>KL University<br> Vijayawada,522501</p>
                              </address>
                    ...
                    <div class="col-md-4 col-sm-6">
                         <div class="footer-info">
                              ...
                              <address>
                                   <p>+91 9014560758, +91 9848565734</p>
                                   <p><a href="mailto:youremail.co">spendsmart@gmail.com</a></p>
                              </address>
